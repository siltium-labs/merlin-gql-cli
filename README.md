...
merlin-gql/0.3.1-next.0 win32-x64 node-v12.19.0
...
_See code: [src\commands\core\local-command.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.1-next.0/src\commands\core\local-command.ts)_
...
_See code: [src\commands\db-reverse.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.1-next.0/src\commands\db-reverse.ts)_
...
_See code: [src\commands\generate\crud.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.1-next.0/src\commands\generate\crud.ts)_
...
_See code: [src\commands\list\entities.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.1-next.0/src\commands\list\entities.ts)_
...
_See code: [src\commands\new.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.1-next.0/src\commands\new.ts)_
...
_See code: [src\commands\watch.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.1-next.0/src\commands\watch.ts)_
<!-- commandsstop -->
* [`merlin-gql core:local-command`](#merlin-gql-corelocal-command)
* [`merlin-gql db-reverse`](#merlin-gql-db-reverse)
* [`merlin-gql generate:crud`](#merlin-gql-generatecrud)
