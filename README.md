...
merlin-gql/0.0.6 win32-x64 node-v10.15.0
...
_See code: [src\commands\generate\entity.ts](https://github.com/ezequielzacca/merlin_cli/blob/v0.0.6/src\commands\generate\entity.ts)_
