...
merlin-gql/0.3.4 win32-x64 node-v10.23.0
...
running command...
$ merlin-gql (-v|--version|version)
merlin-gql/0.3.3 win32-x64 node-v12.20.1
$ merlin-gql --help [COMMAND]
USAGE
  $ merlin-gql COMMAND
...
...
running command...
$ merlin-gql (-v|--version|version)
merlin-gql/0.3.0 win32-x64 node-v12.20.1
$ merlin-gql --help [COMMAND]
USAGE
  $ merlin-gql COMMAND
...
...
running command...
$ merlin-gql (-v|--version|version)
merlin-gql/0.2.34 darwin-x64 node-v12.9.0
$ merlin-gql --help [COMMAND]
USAGE
  $ merlin-gql COMMAND
...
...
_See code: [src/commands/core/local-command.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.4/src/commands/core/local-command.ts)_
...
OPTIONS
  -d, --database=database                           Database name. You can pass multiple values separated by comma.
  -e, --engine=mssql|postgres|mysql|mariadb|oracle  Database engine

  -g, --graphqlFiles                                Generate GraphQL API (inputs, filter, sort, resolver) for entity
                                                    files
  ...
  -s, --schema=schema                               Schema name to create model from. Only for mssql and postgres. You
                                                    can pass multiple values separated by comma eg. -s
  ...
  --skipTables=skipTables                           Skip schema generation for specific tables. You can pass multiple
...
_See code: [src/commands/db-reverse.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.4/src/commands/db-reverse.ts)_
...
_See code: [src/commands/generate/crud.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.4/src/commands/generate/crud.ts)_
...
_See code: [src/commands/list/entities.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.4/src/commands/list/entities.ts)_
...
_See code: [src/commands/new.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.4/src/commands/new.ts)_
...
_See code: [src/commands/watch.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.4/src/commands/watch.ts)_
<!-- commandsstop -->
* [`merlin-gql core:local-command`](#merlin-gql-corelocal-command)
* [`merlin-gql db-reverse`](#merlin-gql-db-reverse)
* [`merlin-gql generate:crud`](#merlin-gql-generatecrud)
...
_See code: [src/commands/core/local-command.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.3/src/commands/core/local-command.ts)_
...
_See code: [src/commands/db-reverse.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.3/src/commands/db-reverse.ts)_
...
_See code: [src/commands/generate/crud.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.3/src/commands/generate/crud.ts)_
...
_See code: [src/commands/list/entities.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.3/src/commands/list/entities.ts)_
...
_See code: [src/commands/new.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.3/src/commands/new.ts)_
...
_See code: [src/commands/watch.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.3/src/commands/watch.ts)_
<!-- commandsstop -->
* [`merlin-gql core:local-command`](#merlin-gql-corelocal-command)
* [`merlin-gql db-reverse`](#merlin-gql-db-reverse)
* [`merlin-gql generate:crud`](#merlin-gql-generatecrud)
...
_See code: [src/commands/core/local-command.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.0/src/commands/core/local-command.ts)_
...
_See code: [src/commands/db-reverse.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.0/src/commands/db-reverse.ts)_
...
_See code: [src/commands/generate/crud.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.0/src/commands/generate/crud.ts)_
...
_See code: [src/commands/list/entities.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.0/src/commands/list/entities.ts)_
...
_See code: [src/commands/new.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.0/src/commands/new.ts)_
...
_See code: [src/commands/watch.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.3.0/src/commands/watch.ts)_
<!-- commandsstop -->
* [`merlin-gql core:local-command`](#merlin-gql-corelocal-command)
* [`merlin-gql db-reverse`](#merlin-gql-db-reverse)
* [`merlin-gql generate:crud`](#merlin-gql-generatecrud)
...
_See code: [src/commands/core/local-command.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.2.34/src/commands/core/local-command.ts)_
...
_See code: [src/commands/db-reverse.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.2.34/src/commands/db-reverse.ts)_
...
_See code: [src/commands/generate/crud.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.2.34/src/commands/generate/crud.ts)_
...
_See code: [src/commands/list/entities.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.2.34/src/commands/list/entities.ts)_
...
_See code: [src/commands/new.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.2.34/src/commands/new.ts)_
