...
merlin-gql/0.1.7 win32-x64 node-v10.15.0
...
_See code: [src\commands\generate\entity.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.1.7/src\commands\generate\entity.ts)_
...
_See code: [src\commands\list\entities.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.1.7/src\commands\list\entities.ts)_
<!-- commandsstop -->
