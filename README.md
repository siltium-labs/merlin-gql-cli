...
merlin-gql/0.2.29 darwin-x64 node-v12.9.0
...
_See code: [src/commands/new.ts](https://github.com/silentium-labs/merlin-gql-cli/blob/v0.2.29/src/commands/new.ts)_
